...
public class CoralRoller extends SubsystemBase implements ActiveSubsystem, DataPublisher {
  ...
  public void publishData() {
    SmartDashboard.putBoolean("Coral Roller/Coral Intook", hasCoral());
    SmartDashboard.putNumber("Coral Roller/Max Velocity", MAX_VELOCITY);
    SmartDashboard.putNumber("Coral Roller/Goal Velocity", goalVelocity);
    SmartDashboard.putNumber("Coral Roller/Current Velocity", currentVelocity);

    // shuffleboard had tabs with command sequences for intaking/delivering
  }
}
